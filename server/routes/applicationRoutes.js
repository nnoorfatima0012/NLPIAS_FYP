...
// router.get('/job/:jobId', protect, ctrl.listForJob);
// router.get('/recruiter/all', protect, ctrl.listForRecruiterAll);

// router.put('/:appId/invite', protect, ctrl.invite);
// router.put('/:appId/confirm', protect, ctrl.confirm);

// // ✅ NEW
// router.get('/:appId', protect, ctrl.getOne);
// router.put('/:appId/reschedule-request', protect, ctrl.rescheduleRequest);
// router.put('/:appId/reschedule-approve', protect, ctrl.rescheduleApprove);
// router.put('/:appId/reschedule-decline', protect, ctrl.rescheduleDecline);
