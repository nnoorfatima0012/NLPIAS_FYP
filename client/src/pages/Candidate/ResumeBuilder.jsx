...
const isNonEmpty = (v) => (typeof v === "string" ? v.trim() !== "" : !!v);
...
const isRowEmpty = (row) => {
  ...
  return Object.values(row).every((v) =>
    Array.isArray(v) ? v.every((x) => !isNonEmpty(x)) : !isNonEmpty(v),
  );
};
...
const removeOrClearRowSmart = (values, setFieldValue, arrayKey, index) => {
  ...
  if (arr.length > 1) {
    if (rowHasData(currentRow)) {
      const ok = window.confirm("Remove this entry? You will lose its data.");
      if (!ok) return;
    }
    setFieldValue(
      arrayKey,
  ...
  if (Array.isArray(section)) {
    return section.some((item) => {
      ...
      if (Array.isArray(item?.technologies) && hasAnyTech(item.technologies))
        return true;
      return (
        item && typeof item === "object" && Object.values(item).some(isNonEmpty)
      );
    });
  }
...
}).test("row-complete-if-started", null, function (row) {
  if (!rowHasData(row)) {
    // Entire row empty → ok, ignore this row
    return true;
  }

  const { level, field, institution, fromYear, toYear, currentlyEnrolled } =
    row || {};
...
const ResumeBuilder = () => {
  ...
  const getSelectedTemplateId = () =>
    selectedVariantId || variants?.[0]?.id || "modern-v1";
  ...
  const handleSaveAndDownload = async (values) => {
    ...
    try {
      ...
      const safeName = (values?.personalDetails?.fullName || "resume").replace(
        /[^\w]+/g,
        "_",
      );
  ...
  const loadResume = async () => {
    try {
      ...
      const patchedValues = {
        ...
        ...fetchedData,
        education:
          Array.isArray(fetchedData.education) &&
          fetchedData.education.length > 0
            ? fetchedData.education
            : [{ ...BLANK_ROWS.education }],
        experience:
          Array.isArray(fetchedData.experience) &&
          fetchedData.experience.length > 0
            ? fetchedData.experience
            : [{ ...BLANK_ROWS.experience }],
        certifications:
          Array.isArray(fetchedData.certifications) &&
        ...
        projects:
          Array.isArray(fetchedData.projects) && fetchedData.projects.length > 0
            ...
            : [{ ...BLANK_ROWS.projects }],
        languages:
          Array.isArray(fetchedData.languages) &&
  ...
  const pollBuilderResumeStatus = () => {
    ...
    const interval = setInterval(async () => {
      ...
      try {
        const res = await api.get("/resume/me/processing-status");
        const status = res.data?.status;

        if (status === "completed") {
          clearInterval(interval);
          setStatusMessage("✅ Resume saved and processed successfully!");
          ...
          setStatusMessage("⏳ Resume saved. Processing in background...");
        }
        ...
        console.error("Polling builder resume status failed:", err);
        clearInterval(interval);
      }
    }, 3000);
  };
  ...
  const handleFinalApply = async (values) => {
    if (!rendered) {
      setApplyMessage(
        "❌ Please generate the resume template first before applying.",
      );
      return;
    }
  ...
  if (isLoading) return <div className="resume-loading">Loading...</div>;
              ...
              <Form className="resume-form">
                ...
                {step === 1 && (
                  <div className="form-step">
                    ...
                    <p className="section-description">
                      Provide a brief overview of your career, highlighting your
                      key skills, experiences and goals
                    </p>
                    <div className="form-field full-width">
                      <Field
                        as="textarea"
                    ...
                    <FieldArray name="education">
                      {({ push }) => (
                        <div className="education-section">
                          ...
                          {values.education.some((edu) => !isRowEmpty(edu)) && (
                            ...
                            <div className="form-grid">
                              <div className="form-field">
                                ...
                                <Field
                                  ...
                                  className={
                                    errors.education?.[editingIndex.education]
                                      ?.level
                                      ? "error"
                                      : ""
                                  }
                              ...
                              <div className="form-field">
                                ...
                                <Field
                                  ...
                                  disabled={
                                    values.education[editingIndex.education]
                                      ?.currentlyEnrolled
                                  }
                                  className={
                                    errors.education?.[editingIndex.education]
                        ...
                        <div className="experience-section">
                          ...
                          <div className="experience-form">
                            <div className="form-grid">
                              ...
                              <div className="form-field">
                                ...
                                <Field
                                  ...
                                  disabled={
                                    values.experience[editingIndex.experience]
                                      ?.currentlyWorking
                                  }
                                >
                                  <option value="">Select year</option>
                            ...
                            <button
                              ...
                              onClick={() => {
                                const newIndex = values.experience.length;
                ...
                {step === 4 && (
                  <div className="form-step">
                    <h2 className="section-title">Showcase your skills</h2>
                    <p className="section-description">
                ...
                {step === 5 && (
                  <div className="form-step">
                    <h2 className="section-title">Showcase your projects</h2>
                    <p className="section-description">
                                  ...
                                  !isRowEmpty(proj) && (
                                    <div key={index} className="project-card">
                                      ...
                                      <div className="card-actions">
                                        ...
                                        {index < values.projects.length - 1 && (
                                          <button
                                            type="button"
                                            className="move-btn"
                                            onClick={() =>
                          ...
                          <div className="project-form">
                            <div className="form-grid">
                              ...
                              <div className="form-field full-width">
                                ...
                                />
                                <div className="char-counter">
                                  {values.projects[editingIndex.projects]
                                    ?.description?.length || 0}
                                  /1500
                                </div>
                              </div>
                            ...
                            <button
                              ...
                              onClick={() => {
                                const newIndex = values.projects.length;
                                push({ ...BLANK_ROWS.projects });
                                setEditingIndexForSection("projects", newIndex);
                              }}
                            >
                              + Add Project
                            </button>
                ...
                {step === 6 && (
                  <div className="form-step">
                    <h2 className="section-title">Add Certifications</h2>
                    <p className="section-description">
                        ...
                        <div className="certifications-section">
                          ...
                          <div className="certification-form">
                            ...
                            <button
                              ...
                              onClick={() => {
                                const newIndex = values.certifications.length;
                                push({
                                  ...BLANK_ROWS.certifications,
                                });
                                setEditingIndexForSection(
                ...
                {step === 7 && (
                  <div className="form-step">
                    ...
                    <p className="section-description">
                      Add any languages you know and specify your proficiency
                      level (Optional)
                    </p>
                      ...
                      {({ push }) => (
                        <div className="languages-section">
                          ...
                          <button
                            ...
                            onClick={() => push({ ...BLANK_ROWS.languages })}
                          >
                            + Add Language
                          </button>
                        </div>
                ...
                {step === 8 && (
                  <div className="form-step">
                    ...
                    <p className="section-description">
                      Add extra sections like <strong>Hobbies</strong>,{" "}
                      <strong>Awards</strong>, <strong>Publications</strong>,{" "}
                      <strong>Interests</strong>, etc. (Optional)
                    </p>

                    <div className="custom-sections-wrap">
                      <h3 className="custom-sections-title">
                        Add custom sections
                      </h3>
                      ...
                      <FieldArray name="customSections">
                        {({ push, move }) => (
                          <div>
                            ...
                            {Array.isArray(values.customSections) &&
                                ...
                                <div className="cards-container">
                                  {values.customSections.map((sec, index) => {
                                    ...
                                    const hasItems =
                                      ...
                                      sec.items.some((x) => (x || "").trim());
                                    const show =
                                      hasTitle || hasText || hasItems;
                                ...
                                <div className="form-field">
                                  ...
                                  <Field
                                    ...
                                    onChange={(e) => {
                                      ...
                                      setFieldValue(
                                        `customSections[${editingIndex.customSections}].type`,
                                        val,
                                      );
                                      ...
                                      if (val === "tags") {
                                        setFieldValue(
                                          `customSections[${editingIndex.customSections}].content`,
                                          "",
                                        );
                                        setFieldValue(
                                          `customSections[${editingIndex.customSections}].items`,
                                          [],
                                        );
                                      } else {
                                        setFieldValue(
                              ...
                              <button
                                ...
                                onClick={() => {
                                  ...
                                  const hasItems =
                                    ...
                                    current.items.some((x) => (x || "").trim());

                                  if (!titleOk) {
                                    alert(
                                      "Please enter a section title (e.g., Hobbies).",
                                    );
                                    return;
                                  }
                ...
                {step === 9 && (
                  <div className="form-step">
                    ...
                    <p className="section-description">
                      Please review your resume below. Generate templates, pick
                      a theme and format, then download your PDF.
                    </p>
                      ...
                      <button
                        ...
                        onClick={async () => {
                          ...
                          try {
                            ...
                            if (!data?.viewModel) {
                              console.error(
                                "Render failed: no viewModel returned",
                              );
                    ...
                    >
                      ...
                      <div className="preview-section">
                        {rendered ? (
                          ...
                          >
                            Click <strong>Generate resume templates</strong> to
                            see the AI formatted resume.
                          </div>
                        )}
                      </div>
                    ...
                    <div className="submit-section">
                      {rendered && variants.length > 0 && (
                        <button
                          ...
                          title={
                            !isValid ? "Please complete required fields" : ""
                          }
                        >
                          {downloading
                            ? "Downloading..."
